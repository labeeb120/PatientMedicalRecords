...
### 6.4 معالجة المرفقات الطبية (File Upload Mechanism)
يدعم النظام رفع الملفات بصيغ (PDF, JPG, PNG) لتوثيق الشهادات أو التقارير الخارجية.
*   **التحقق:** يتم التحقق من الامتداد (White-listing) والحجم (Max 5MB).
*   **التخزين:** يتم توليد اسم فريد (Guid) لمنع تداخل الملفات وحفظها في مجلد معزول `Attachments`.
*   **الأمن:** يتم تخزين مسار الملف في قاعدة البيانات، ولا يمكن الوصول إليه إلا عبر توكن JWT صالح وصلاحيات مناسبة.

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PatientId = table.Column<int>(type: "int", nullable: false),
                    SurgeryName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    SurgeryDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Hospital = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Surgeon = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PrescriptionDispenses_Pharmacists_PharmacistId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 101, new DateTime(2025, 10, 1, 21, 19, 20, 939, DateTimeKind.Utc).AddTicks(1334), "admin@medicalrecords.com", "System Administrator", null, "1000000001", "$2a$11$96UOSeER2rzOrMtv8PaBruFKg5SZ4wZeXyQRVkMeM1Ln3GuqEdx0m", null, 4, 2, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionDispenses_PharmacistId",
                table: "PrescriptionDispenses",
                column: "PharmacistId");

            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionDispenses_PrescriptionId",
                table: "PrescriptionDispenses",
